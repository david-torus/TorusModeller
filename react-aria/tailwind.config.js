  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        sfproblackitalic:['SF-Pro-Display-Black-italic'],
        sfprosemibolditalic:['SF-Pro-Display-semibold-italic'],
        sfproheavyitalic:['SF-Pro-Display-heavy-italic'],
        sfprolightitalic:['SF-Pro-Display-light-italic'],
        sfproultrathinitalic:['SF-Pro-Display-ultrathin-italic'],
      },
    },
  },
  variants: {
