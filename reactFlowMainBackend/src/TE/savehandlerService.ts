           ...
           var artifact = pKey.split(':')[4]
            ...
            if(mode == 'E')  {
              ...
              formdata = await this.teService.staticCodeExec(sfkey,pKey,upId,nodeId,nodeName,obj,token,mode)
                ...
                formdata = await this.teService.getFormdata(sfkey,pKey,upId,nodeId,cnodeName,obj,token)            
              }else{
                formdata = await this.teService.getFormdata(sfkey,pKey,upId,nodeId,nodeName,obj,token)           
              }   
            }
            else if(mode == 'D'){
            ...
            const requestConfig: AxiosRequestConfig = {
              ...
              .postCall(apiurl, obj, requestConfig)
