    ...
    <Input
      ...
      classNames={{
        ...
        inputWrapper: darkMode
          ? [
              "h-[4px] rounded-md text-slate-700  bg-transparent hover:bg-[#D9DEE8] hover:border-blue-500/50 hover:text-slate-700 border border-slate-500/50 ",
              "data-[focused=true]:border-pink-500/50",
            ]
          : [
              "h-[4px] rounded-md text-black bg-transparent hover:bg-[#D9DEE8] hover:border-blue-500/50 hover:text-pink-500 border border-slate-500/75 ",
            ],
      }}
      {...inputProps}
    />
